...
export type Schema = EthBridgeTransferMsgValue | IbcTransferMsgValue | SignatureMsgValue | SubmitBondMsgValue | SubmitUnbondMsgValue | SubmitVoteProposalMsgValue | SubmitWithdrawMsgValue | TransferMsgValue | TxMsgValue;
