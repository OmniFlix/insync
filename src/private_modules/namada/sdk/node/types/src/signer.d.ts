...
export interface Signer {
    ...
    sign: (tx: TxProps | TxProps[], signer: string, checksums?: Record<string, string>) => Promise<Uint8Array[] | undefined>;
    signArbitrary: (signer: string, data: string) => Promise<SignArbitraryResponse | undefined>;
