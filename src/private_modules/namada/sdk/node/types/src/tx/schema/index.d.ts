...
import { ShieldedTransferDataMsgValue, ShieldedTransferMsgValue, ShieldingTransferDataMsgValue, ShieldingTransferMsgValue, TransferDataMsgValue, TransferMsgValue, TransparentTransferDataMsgValue, TransparentTransferMsgValue, UnshieldingTransferDataMsgValue, UnshieldingTransferMsgValue } from "./transfer";
...
export type Schema = BatchTxResultMsgValue | EthBridgeTransferMsgValue | IbcTransferMsgValue | SignatureMsgValue | BondMsgValue | UnbondMsgValue | VoteProposalMsgValue | ClaimRewardsMsgValue | WithdrawMsgValue | ShieldedTransferMsgValue | ShieldedTransferDataMsgValue | ShieldingTransferMsgValue | ShieldingTransferDataMsgValue | SigningDataMsgValue | TransferMsgValue | TransferDataMsgValue | TransparentTransferMsgValue | TransparentTransferDataMsgValue | TxMsgValue | TxResponseMsgValue | UnshieldingTransferDataMsgValue | UnshieldingTransferMsgValue | WrapperTxMsgValue | RedelegateMsgValue | CommitmentMsgValue | TxDetailsMsgValue | RevealPkMsgValue;
