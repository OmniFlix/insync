...
export const Tokens = {
    ...
    NAM: Object.assign(Object.assign({}, getSlip44Info("NAM")), { url: "https://namada.net", address: nativeToken, symbol: "Naan", minDenom: "namnam", decimals: 6 }),
    DOT: Object.assign(Object.assign({}, getSlip44Info("DOT")), { address: "tnam1qyfl072lhaazfj05m7ydz8cr57zdygk375jxjfwx", coinGeckoId: "polkadot", minDenom: "", decimals: 0 }),
    ETH: Object.assign(Object.assign({}, getSlip44Info("ETH")), { address: "tnam1qxvnvm2t9xpceu8rup0n6espxyj2ke36yv4dw6q5", coinGeckoId: "ethereum", minDenom: "", decimals: 0 }),
    BTC: Object.assign(Object.assign({}, getSlip44Info("BTC")), { address: "tnam1qy8qgxlcteehlk70sn8wx2pdlavtayp38vvrnkhq", coinGeckoId: "bitcoin", minDenom: "", decimals: 0 }),
