...
export const showFeeOptionsPopover = (anchorEl) => {
    return {
        type: FEE_OPTIONS_POPOVER_SHOW,
        anchorEl,
    };
}

export const hideFeeOptionsPopover = () => {
    return {
        type: FEE_OPTIONS_POPOVER_HIDE,
    };
}

export const setFeeOptionPopoverValue = (value) => {
    return {
        type: FEE_OPTIONS_POPOVER_SET,
        value,
    };
}
