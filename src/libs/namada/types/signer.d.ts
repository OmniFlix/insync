...
import { BridgeTransferProps, IbcTransferProps, SubmitBondProps, SubmitUnbondProps, SubmitVoteProposalProps, SubmitWithdrawProps, TransferProps, TxProps } from "./tx";
...
export interface Signer {
    ...
    sign: (signer: string, data: string) => Promise<SignatureResponse | undefined>;
    ...
    submitVoteProposal(args: SubmitVoteProposalProps, txArgs: TxProps, type: AccountType): Promise<void>;
    submitEthBridgeTransfer(args: BridgeTransferProps, txArgs: TxProps, type: AccountType): Promise<void>;
}
